...
void E2E_test()
{
    ...
    char line1[100];
    FILE *check = fopen("test_data.csv", "r");
    assert(check != NULL);
    ...
    char line2[100];
    FILE *check2 = fopen("test_data.csv", "r");
    assert(check2 != NULL);
    ...
    FILE *Dfile = fopen("test_DEdata.csv", "w");
    assert(Dfile != NULL);
    ...
    FILE *check3 = fopen("test_DEdata.csv", "r");
    assert(check3 != NULL);
    char line3[100];
    ...
    FILE *finalCheck = fopen("test_data.csv", "r");
